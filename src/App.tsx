...
function App() {
    ...
    useEffect(() => {
        if (window.ribbit) {
            ...
            addLog('⚠️ Ribbit Wallet not detected. Please install the Ribbit Wallet extension.');
        }
    }, []);
    ...
    const connectToWallet = async () => {
        ...
        try {
            ...
            const response: ConnectResponse = await window.ribbit.connectToWallet(dappMetadata);
            ...
            if (response.approved) {
                ...
                addLog(`❌ Connection rejected: ${response.error || response.message || 'Unknown error'}`);
            }
        } catch (error) {
    ...
    return (
        <div className="App">
            <header className="App-header">
                ...
                <p>Demo application showcasing the Ribbit Wallet Connect SDK integration</p>
            ...
            <main className="App-main">
                    ...
                    <section className="wallet-info">
                        ...
                        <div className="info-grid">
                            ...
                            <div className="info-item">
                                ...
                                <code>{chainId} {chainId === 6 ? '(Supra Testnet)' : chainId === 8 ? '(Supra Mainnet)' : ''}</code>
                            </div>
                            <div className="info-item">
                ...
                <section className="documentation-section">
                    ...
                    <div className="docs-grid">
                        <div className="doc-item">
                            <h4>Chain IDs</h4>
                            <ul>
                                <li>Supra Testnet: <code>6</code></li>
                                <li>Supra Mainnet: <code>8</code></li>
                            </ul>
                        </div>
                        <div className="doc-item">
                            <h4>Key Methods</h4>
                            <ul>
                                <li><code>window.ribbit.connectToWallet()</code></li>
                                <li><code>window.ribbit.sendTransaction()</code></li>
                                <li><code>window.ribbit.getSessionStatus()</code></li>
                                <li><code>window.ribbit.disconnect()</code></li>
                            </ul>
                        </div>
                    </div>
                </section>
                ...
                <section className="logs-container">
                    ...
                    <div className="logs">
                        {logs.length === 0 ? (
                            <p className="no-logs">No activity yet. Try connecting to the wallet!</p>
                        ) : (
                            logs.map((log, index) => (
